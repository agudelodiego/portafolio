...
const Home = ()=>{
    ...
    return(
        <HomePage tema={tema}>
            <TextContainer>
                <Texto tema={tema}>
                    ¡Hola mundo y bienvenidos!. Soy Diego, un desarrollador full stack Colombiano a quien le apasiona mucho el mundo de la tecnología. Y recuerda siempre: "¡Si pudes imaginarlo, pudes programarlo!".
                </Texto>
            </TextContainer>
            <ImgContainer>
